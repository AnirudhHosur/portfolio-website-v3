# Vercel deployment compatible FastAPI app
import logging
import uuid
...
app = FastAPI(
    ...
    description="AI-powered chatbot for interacting with professional profile",
    version="1.0.0"
)
...
async def ingest_pdf_endpoint(file: UploadFile = File(...), source_id: str = Form(...)):
    """Direct endpoint for PDF ingestion"""
    # Save uploaded file
...
async def query_pdf_endpoint(request: dict):
    """Direct endpoint for RAG queries"""
    try:
...
# Job Alignment Analysis Endpoint
